...
package webshop.persistence.config;
...
public class PersistenceUnitProperties
{
    ...
    public static final String USER     = propertyPrefix + "klugflor16";
    public static final String PASSWORD = propertyPrefix + "klugswd16";
    public static final String URL      = propertyPrefix + "postgresql://10.65.1.37:5433/db_klug16";
    public static final String DRIVER   = propertyPrefix + "org.postgresql.Driver";
